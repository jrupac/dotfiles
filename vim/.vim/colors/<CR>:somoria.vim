...
if &background == "dark"
    ...
    if s:moria_monochrome == 1
        ...
        hi StatusLine 	guifg=#d3d3d5 guibg=#444444 gui=italic ctermfg=DarkGreen ctermbg=238 cterm=italic
        hi StatusLineNC guifg=#939395 guibg=#444444 gui=none ctermfg=gray ctermbg=234
...
hi Folded 		guibg=#384048 guifg=#a0a8b0 gui=none ctermfg=black ctermbg=blue
hi Visual		guifg=#ffffd7 guibg=#444444 gui=none ctermfg=186 ctermbg=238
hi LineNr 		guifg=#808080 guibg=#000000 gui=none ctermfg=26 ctermbg=16
