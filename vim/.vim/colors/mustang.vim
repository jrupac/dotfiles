...
if version >= 700
  hi clear CursorLine
  hi CursorLine guibg=#2d2d2d ctermbg=237 ctermfg=none
...
hi Folded 		guibg=#384048 guifg=#a0a8b0 gui=none ctermfg=239 ctermbg=232
...
hi String 		guifg=#ff9800 gui=none ctermfg=208
